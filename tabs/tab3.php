...
<div id="contenedor_de_asignacion">
    ...
    <div id="columna_central">
        <h1 align="center">Asignar Grabaciones a Tel&eacute;fonos</h1>

        <table id="espacio_droppable_t3" border="0">
            <tr>
                <th width="20%">TEL&Eacute;FONO</th>
                <th width="80%">GRABACI&Oacute;N</th>
            </tr>
        </table>
        ...
        <div>
            ...
            <span>|</span>
            <a id="guardar_tab3" href="#">GUARDAR</a>
        </div>
    </div>
